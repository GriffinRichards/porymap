...
QImage getMetatileLayerImage(uint16_t, int, Tileset *, Tileset *, bool useTruePalettes = false);
QImage getMetatileLayerImage(Metatile *, int, Tileset *, Tileset *, bool useTruePalettes = false);
