...
void MainWindow::setSong(QString song) {
    if (!this->mapHeader || !this->editor || !this->editor->project)
        return;
    if (!this->editor->project->songNames.contains(song)) {
        logError(QString("Unknown song '%1'").arg(song));
        return;
    }
    this->mapHeader->ui->comboBox_Song->setCurrentText(song);
}
...
void MainWindow::setLocation(QString location) {
    ...
    this->mapHeader->ui->comboBox_Location->setCurrentText(location);
}
...
void MainWindow::setRequiresFlash(bool require) {
    if (!this->mapHeader)
        return;
    this->mapHeader->ui->checkBox_RequiresFlash->setChecked(require);
}
...
void MainWindow::setWeather(QString weather) {
    ...
    this->mapHeader->ui->comboBox_Weather->setCurrentText(weather);
}
...
void MainWindow::setType(QString type) {
    ...
    this->mapHeader->ui->comboBox_Type->setCurrentText(type);
}
...
void MainWindow::setBattleScene(QString battleScene) {
    ...
    this->mapHeader->ui->comboBox_BattleScene->setCurrentText(battleScene);
}
...
void MainWindow::setShowLocationName(bool show) {
    if (!this->mapHeader)
        return;
    this->mapHeader->ui->checkBox_ShowLocationName->setChecked(show);
}
...
void MainWindow::setAllowRunning(bool allow) {
    if (!this->mapHeader)
        return;
    this->mapHeader->ui->checkBox_AllowRunning->setChecked(allow);
}
...
void MainWindow::setAllowBiking(bool allow) {
    if (!this->mapHeader)
        return;
    this->mapHeader->ui->checkBox_AllowBiking->setChecked(allow);
}
...
void MainWindow::setAllowEscaping(bool allow) {
    if (!this->mapHeader)
        return;
    this->mapHeader->ui->checkBox_AllowEscaping->setChecked(allow);
}
...
void MainWindow::setFloorNumber(int floorNumber) {
    if (!this->mapHeader)
        return;
    this->mapHeader->ui->spinBox_FloorNumber->setValue(floorNumber);
}
